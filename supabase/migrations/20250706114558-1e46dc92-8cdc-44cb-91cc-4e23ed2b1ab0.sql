-- Insert content pages for Help & Support, About Us, Contact Us, Privacy Policy, and Terms of Service
INSERT INTO public.content_pages (slug, title, content, excerpt, seo_title, seo_description, page_type, is_published) VALUES
(
  'help',
  'Help & Support',
  'Welcome to our Help & Support center! We''re here to assist you on your Arabic vocabulary learning journey.
...
<li><strong>Review Regularly:</strong> Use our spaced repetition system for optimal retention</li>
  ...
  'Get help with your Arabic vocabulary learning journey. Find answers to common questions and access support resources.',
  'Help & Support - Arabic Vocabulary Learning Platform',
  'Get help with Arabic vocabulary learning, troubleshooting guides, and support resources for mastering Quranic Arabic.',
  'support',
  true
),
(
  'about',
  'About Us',
  '<h1>About Arabic Vocabulary Learning Platform</h1>
...
<p>Join thousands of learners who are already on their path to mastering Arabic vocabulary. Start your journey today and discover the beauty of the Arabic language.</p>',
  'Learn about our mission to make Arabic vocabulary learning accessible for students of Islam and Quranic studies.',
  'About Us - Arabic Vocabulary Learning Platform',
  'Discover our mission to help Muslims master Arabic vocabulary for better understanding of the Quran and Islamic texts.',
  'static',
  true
),
(
...
<li>YouTube: Arabic Vocabulary Learning</li>
  ...
  'Get in touch with our support team for help with your Arabic vocabulary learning journey.',
  'Contact Us - Arabic Vocabulary Learning Platform',
  'Contact our support team for help with Arabic vocabulary learning, technical issues, and general inquiries.',
  'static',
  true
),
(
...
<li>Website: <a href="/contact">Contact Us</a></li>
  ...
  'Learn how we protect your privacy and handle your personal information on our Arabic vocabulary learning platform.',
  'Privacy Policy - Arabic Vocabulary Learning Platform',
  'Read our privacy policy to understand how we collect, use, and protect your personal information while learning Arabic vocabulary.',
  'legal',
  true
),
(
...
<p>If any provision of these Terms is found to be unenforceable, the remaining provisions will remain in full force and effect.</p>',
  'Read our terms of service to understand the rules and guidelines for using our Arabic vocabulary learning platform.',
  'Terms of Service - Arabic Vocabulary Learning Platform',
  'Review our terms of service, user agreements, and guidelines for using our Arabic vocabulary learning platform.',
  'legal',
  true
);